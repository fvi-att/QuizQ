...
// in simulator we redefine to format for Secret Developer console
...
{\
	NSString * exceptionName = [@"org.secret." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.secret";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UISecretNativeItemNone = -1, 
	UISecretNativeItemSpinner = -2,
	UISecretNativeItemProgressBar = -3,
	
	UISecretNativeItemSlider = -4,
	UISecretNativeItemSwitch = -5,
	UISecretNativeItemMultiButton = -6,
	UISecretNativeItemSegmented = -7,
	
	UISecretNativeItemTextView = -8,
	UISecretNativeItemTextField = -9,
	UISecretNativeItemSearchBar = -10,
	
	UISecretNativeItemPicker = -11,
	UISecretNativeItemDatePicker = -12,
	
	UISecretNativeItemInfoLight = -13,
	UISecretNativeItemInfoDark = -14,
	
	UISecretNativeItemDisclosure = -15,
	
	UISecretNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Secret instances of
