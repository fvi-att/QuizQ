 ...
 * Copyright (c) 2009-2011 by Secret, Inc. All Rights Reserved.
...
//@interface SecretObject : NSObject
//@end

@interface SecretObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SecretObject class]])
		{
			for (NSString *key in [[(SecretObject*)o modules] allKeys])
			{
