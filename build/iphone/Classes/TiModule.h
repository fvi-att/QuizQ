...
/**
 The base class for all Secret modules
 */
...
/**
 Secret Platform calls this method on startup.
 */
-(void)startup;

/**
 Secret Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Secret Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Secret Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Secret Platform calls this method on resume.
 @param sender The sender of the event.
 */
